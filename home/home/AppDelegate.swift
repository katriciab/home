...
//        // The directory the application uses to store the Core Data store file. This code uses a directory named "com.katriciab.home" in the application's documents Application Support directory.
...
//        let modelURL = NSBundle.mainBundle().URLForResource("home", withExtension: "momd")!
...
//        let url = self.applicationDocumentsDirectory.URLByAppendingPathComponent("HomeCoreData.sqlite")
